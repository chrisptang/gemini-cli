...
export function AuthDialog({
  ...
  const [errorMessage, setErrorMessage] = useState<string | null>(() => {
    ...
    if (
      ...
      (!defaultAuthType || defaultAuthType === AuthType.USE_OPENAI_COMPATIBLE)
    ) {
      return 'Existing OpenAI API key detected (OPENAI_API_KEY). Select "OpenAI-Compatible API" option to use it.';
    }
    return null;
  });
  const items = [
